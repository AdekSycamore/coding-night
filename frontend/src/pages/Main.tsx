...
<main className="bg-sky-500">
    ...
    <div className="h-[32rem] bg-gray-100 dark:bg-gray-800">
        ...
        <h1 className="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">The Executive Team</h1>
    ...
    <div className="container mx-auto -mt-72 px-6 py-10 sm:-mt-80 md:-mt-96">
        ...
        <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
            ...
            <h1 className="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">arthur melo</h1>
        ...
        <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
            ...
            <h1 className="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">Pamela Anderson</h1>
        ...
        <div className="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
            ...
            <h1 className="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">John Doe</h1>
    ...
    <section className="bg-white dark:bg-gray-900">
    <div className="container mx-auto px-6 py-10">
        <h1 className="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">What clients saying</h1>
    ...
    <div className="container mx-auto px-6 py-10">
        ...
        <div>
            ...
            <img className="h-64 w-full rounded-lg object-cover object-center lg:h-80" src="https://images.unsplash.com/photo-1624996379697-f01d168b1a52?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" />
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis fugit dolorum amet dolores praesentium, alias nam? Tempore</p>

            <a href="#" className="mt-4 inline-block text-blue-500 underline hover:text-blue-400">Read more</a>
        </div>

        <div>
            <div className="relative">
            <img className="h-64 w-full rounded-lg object-cover object-center lg:h-80" src="https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="" />
        ...
        <div>
            <div className="relative">
            <img className="h-64 w-full rounded-lg object-cover object-center lg:h-80" src="https://images.unsplash.com/photo-1597534458220-9fb4969f2df5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80" alt="" />
    ...
    <div className="container mx-auto px-6 py-8">
        <h1 className="text-center text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">Pricing Plan</h1>

        <p className="mx-auto mt-4 max-w-2xl text-center text-gray-500 dark:text-gray-300 xl:mt-6">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias quas magni libero consequuntur voluptatum velit amet id repudiandae ea, deleniti laborum in neque eveniet.</p>
        ...
        <div className="w-full space-y-8 rounded-lg border border-gray-100 p-8 text-center dark:border-gray-700">
            <p className="font-medium uppercase text-gray-500 dark:text-gray-300">Free</p>

            <h2 className="text-5xl font-bold uppercase text-gray-800 dark:text-gray-100">$0</h2>

            <p className="font-medium text-gray-500 dark:text-gray-300">Life time</p>

            <button className="mt-10 w-full transform rounded-md bg-blue-600 px-4 py-2 capitalize tracking-wide text-white transition-colors duration-300 hover:bg-blue-500 focus:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">Start Now</button>
        </div>
        ...
        <div className="w-full space-y-8 rounded-lg bg-blue-600 p-8 text-center">
            ...
            <h2 className="text-5xl font-bold uppercase text-white dark:text-gray-100">$40</h2>

            <p className="font-medium text-gray-200">Per month</p>

            <button className="mt-10 w-full transform rounded-md bg-white px-4 py-2 capitalize tracking-wide text-blue-500 transition-colors duration-300 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-200 focus:ring-opacity-80">Start Now</button>
        </div>

        <div className="w-full space-y-8 rounded-lg border border-gray-100 p-8 text-center dark:border-gray-700">
            <p className="font-medium uppercase text-gray-500 dark:text-gray-300">Enterprise</p>

            <h2 className="text-5xl font-bold uppercase text-gray-800 dark:text-gray-100">$100</h2>
    ...
    <div className="container mx-auto max-w-4xl px-6 py-10">
        ...
        <div className="rounded-lg border-2 border-gray-100 dark:border-gray-700">
            ...
            <p className="p-8 text-sm text-gray-500 dark:text-gray-300">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas eaque nobis, fugit odit omnis fugiat deleniti animi ab maxime cum laboriosam recusandae facere dolorum veniam quia pariatur obcaecati illo ducimus?</p>
        </div>
