...
const Navbar = () => {
    return (
        <nav  className="flex p-6 lg:flex lg:justify-between  dark:bg-gray-900">
        ...
        <div className="absolute inset-x-0 z-20 w-full bg-white px-6 shadow-md transition-all duration-300 ease-in-out dark:bg-gray-900 lg:relative lg:top-0 lg:mt-0 lg:flex lg:w-auto lg:translate-x-0 lg:items-center lg:bg-transparent lg:p-0 lg:opacity-100 lg:shadow-none lg:dark:bg-transparent">
        <div className="lg:px-8 flex flex-col lg:mt-0 lg:flex-row lg:space-y-0">
            <Link to="/">
